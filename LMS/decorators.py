...
def facilitator_required(
    ...
    # Define the test function: checks if the user is active and a superuser
    def test_func(user):
        return user.is_active and user.is_facilitator or user.is_superuser
...
def sponsor_required(
    ...
    # Define the test function: checks if the user is active and a superuser
    def test_func(user):
        return user.is_active and user.is_sponsor or user.is_superuser
